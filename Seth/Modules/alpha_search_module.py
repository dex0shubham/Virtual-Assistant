from Seth.Modules.base_module import BaseModule
from Seth.local_libs.wolframalpha_speech.index import WolframalphaSpeech
from Seth.local_libs.wolframalpha_speech.exceptions_manager import *
