...
from Seth.activity import Activity
from Seth.virtual_assistant import VirtualAssistant
from Seth.EventDispatcher.event_dispatcher import EventDispatcher
from Seth.TextManager.text_manager import TextManager
from Seth.configurer import config
from Seth.updater import Updater
...
class Boot:
    ...
    def initiate(self):
        print("Seth is on and loading, wait for the beep sound to give your command.")
