...
class Updater:
	...
	def check_for_update(self):
		try:
			...
			print("Couldn't access Seth's version update information.")
			return
		try:
			if str(self.current_version) != str(self.data['version']):
				...
				if int(self.data['print_status']):
					print("Kindly visit the main website of Seth at www.github.com/slapbot/Seth-va to update the software to it's latest version.")
